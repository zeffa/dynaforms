            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Create any form you need with our intuitive drag-and-drop
                  builder. Add fields, set validations, and configure options on
                  the fly.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Built-in validation rules, custom patterns, and real-time
                  feedback ensure data quality and improve user experience.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  View, analyze, and export form responses. Get insights from
                  your data with detailed submission reports and CSV exports.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Enterprise-grade security with data encryption and secure form
                  submissions. Your data is safe and protected.
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-8 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Intuitive admin dashboard for creating, editing, and managing
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-gray-400">
                  The most flexible dynamic form builder for businesses of all
                  sizes.
                </p>
              </div>
              <div>
