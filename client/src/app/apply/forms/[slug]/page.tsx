          ...
          <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-8">
                ...
                {form.category && ` This ${form.category.toLowerCase()} form submission will be reviewed shortly.`}
              </p>
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={form.description || `Fill out the ${form.name} form`} />
        {form.category && <meta name="keywords" content={`${form.category}, form, ${form.name}`} />}
      </Head>
            ...
            <div className="flex">
              ...
              <div className="ml-3 text-sm">
                <p className="text-blue-800">
                  <strong>Privacy Notice:</strong> Your information will be handled securely and in accordance with our privacy policy. 
                  Required fields are marked with an asterisk (*).
                </p>
                {form.category && (
                  <p className="text-blue-700 mt-1">
                    This form is categorized under: <span className="font-medium">{form.category}</span>
                  </p>
                )}
              </div>
            </div>
